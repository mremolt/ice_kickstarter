= v0.0.3
  * Added optional contact_form component that is connected to the WebCRM and prefills email, when
    user is logged in. Call ```rails generate cms:component:contact_form```.
